...
//Opgave 2: Boldens øjne bevæger sig og forstørres forkert. Det skal rettes (hint: se datatyperne)
...
float   ballX             = 100 ,  ballY             = 100; // hvis vi skal plusse med Ballwalk ved linje 27 skal denne datatype være et float
float   eyeLeftRelativeX  = 5   ,  eyeLeftRelativeY  = 5;
float   eyeRightRelativeX = 20  ,  eyeRightRelativeY = 5;   
int   speedX            = 1   ,  speedY            = 1;
float ballSize          = 50; //når der ganges med zoomFactor ved linje 30-33 ganger man et heltal med et realt tal og dette fungerer ikke derfor skal ballSize være et realt tal et float og ikke et heltal eller int 
float eyeSize           = 5;
...
void draw() {                         
  ...
  ballY         =  ballY  +  speedY + ballwalk; //vi plusser her med ballwalk for at få svingninger på y-aksen
